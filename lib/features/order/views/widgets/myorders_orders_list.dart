...
Widget buildOrderList(BuildContext context, {required bool isOngoing}) {
  ...
  return StreamBuilder<QuerySnapshot>(
    // Listen to the user's orders instantly, sorted by latest
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 8),
                   ...
                   Text(
                    'Qty: ${order.quantity}${order.size != null && order.size != 'N/A' && order.size!.isNotEmpty ? '  •  Size: ${order.size}' : ''}${order.color != null && order.color != 'N/A' && order.color!.isNotEmpty ? '  •  Color: ${order.color}' : ''}',
                    style: TextStyle(
